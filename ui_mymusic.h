...
public:
    ...
    void setupUi(QWidget *MyMusic)
    {
        ...
        combo_image->setGeometry(QRect(580, 280, 161, 51));
        QFont font1;
        ...
        lianji_image = new QLabel(page);
        lianji_image->setObjectName(QStringLiteral("lianji_image"));
        lianji_image->setGeometry(QRect(580, 420, 181, 51));
        QFont font2;
        font2.setFamily(QStringLiteral("Arial Black"));
        font2.setPointSize(16);
        font2.setBold(true);
        font2.setWeight(75);
        lianji_image->setFont(font2);
